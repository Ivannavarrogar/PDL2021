...
public class MTransiciones{
    ...
    private static final int PORCEN = 4 ; 
    ...
    public MTransiciones() {
        ...
        matriz[11][EOL] = new Tupla(12,"K");
      

        //Comentarios
        matriz[4][SLASH] = new Tupla(5, "L");
        matriz[5][LET] = new Tupla(5, "L");
        matriz[5][DIG] = new Tupla(5, "L");
        matriz[5][DEL] = new Tupla(5, "L");
        matriz[5][ASTERISCO] = new Tupla(5, "L");
        matriz[5][SLASH] = new Tupla(5, "L");
        matriz[5][OTROS] = new Tupla(5, "L");
        matriz[5][PORCEN] = new Tupla(5, "L");
        matriz[5][EOL] = new Tupla(0, "L");
